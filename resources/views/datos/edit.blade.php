                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!!Form::select('idubigeo',UbigeoPersonal($postulante->idubigeo) ,null , ['id'=>'Ubigeo','class'=>'form-control']);!!}
                        </div>
                    </div><!--span-->
                </div><!--row-->
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!!Form::select('idcolegio',ColegioPersonal($postulante->idcolegio) ,null , ['id'=>'Colegio','class'=>'form-control']);!!}
                        </div>
                    </div><!--span-->
                </div><!--row-->
                <div class="row">
